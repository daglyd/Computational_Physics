...
int main(){
    ...
    ofstream file; 
    file.open("Data/main_two_particle_exp/positions_euler_cromer_wo_interact.csv");
    file << "Particle,"<<"x,"<<"y,"<<"z"<<endl;
    
    ofstream file2;
    file2.open("Data/main_two_particle_exp/velocities_euler_cromer_wo_interact.csv");
    ...
    for (int i=0; i < n_steps; i++){
        ...
        trap.evolve_Euler_Cromer_without_particle_interaction(dt);
    }
    file.close();
    file2.close();
